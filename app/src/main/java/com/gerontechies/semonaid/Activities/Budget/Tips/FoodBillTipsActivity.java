...
public class FoodBillTipsActivity extends AppCompatActivity {

    Button btn_foodbilltips1, btn_foodbilltips2;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_foodbilltips);
        ...
        btn_foodbilltips1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(FoodBillTipsActivity.this, FoodBillTips1Activity.class);
        ...
        btn_foodbilltips2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(FoodBillTipsActivity.this, FoodBillTips2Activity.class);
                startActivity(intent);
            }
        });
    }
