...
public class TravelTipsActivity extends AppCompatActivity {
    ...
    Button btn_traveltips1, btn_traveltips2;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_traveltips);
        ...
        btn_traveltips1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TravelTipsActivity.this, TravelTips1Activity.class);
        ...
        btn_traveltips2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TravelTipsActivity.this, TravelTips2Activity.class);
                startActivity(intent);
            }
        });
    }
